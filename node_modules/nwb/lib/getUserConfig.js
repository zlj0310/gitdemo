  ...
  if (userConfig.webpack.compat) {
    if (userConfig.webpack.compat.enzyme) {
      if (!warnedAboutEnzymeCompat) {
        report.deprecated('webpack.compat.enzyme', `The ${_chalk2.default.cyan('enzyme')} compat flag applies to Enzyme v2, which has been superseded by Enzyme v3.`, 'Consider upgrading to Enzyme v3 if you can, which requires configuring Enzyme rather than Webpack.');
